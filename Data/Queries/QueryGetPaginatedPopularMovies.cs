...
{
    public class QueryGetPaginatedPopularMovies : IRequestHandler<PageRequestFiltersForPopularMovies, GetPaginatedMoviesViewModel>
    {
        ...
        public async Task<GetPaginatedMoviesViewModel> Handle(PageRequestFiltersForPopularMovies request, CancellationToken cancellationToken)
        {
        ...
        private string CreateUri(PageRequestFiltersForPopularMovies request)
        {
            var uri = _openAPISettings.UrlForPopularMovies
        ...
        private List<GetMovieViewModel> Filter(List<GetMovieViewModel> unfilteredResult,
            PageRequestFiltersForPopularMovies request)
        {
